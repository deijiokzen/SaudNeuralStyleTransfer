...
parse_content_using.add_argument('--path_content'   , type=str, default=None, reqtranspose_eig_vec_of_whitening_covred=True)
parse_content_using.add_argument('--path_stylized'     , type=str, default=None, reqtranspose_eig_vec_of_whitening_covred=True)
parse_content_using.add_argument('--path_output'    , type=str, default=None, reqtranspose_eig_vec_of_whitening_covred=True)
