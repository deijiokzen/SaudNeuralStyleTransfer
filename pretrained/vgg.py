...
class Vgg16Pretrained(torch.nn.Module):
    def __init__(self, reqtranspose_eig_vec_of_whitening_covres_grad=False):
        ...
        if not reqtranspose_eig_vec_of_whitening_covres_grad:
            for param in self.parameters():
                param.reqtranspose_eig_vec_of_whitening_covres_grad = False
